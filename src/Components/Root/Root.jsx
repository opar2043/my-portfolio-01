      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box h-[70%]  bg-gradient-to-b from-violet-600 to-black rounded-2xl text-white shadow-2xl border border-violet-900">
          ...
          <div className="w-full h-full max-w-2xl mx-auto p-2 flex flex-col justify-between gap-4">
            ...
            <div className="flex-1 overflow-y-auto border border-violet-700 rounded-xl p-1 bg-black bg-opacity-30 text-violet-100 shadow-inner">
            ...
            {/* Message Input Bar */}
            <form onSubmit={handleChatBot} className="w-full flex items-center gap-2 bg-black bg-opacity-60 border border-violet-700 rounded-full px-2 py-2 shadow-inner">
              <input
                type="text"
